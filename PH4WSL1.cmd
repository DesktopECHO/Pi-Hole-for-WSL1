...
START /WAIT /MIN "Installing Ubuntu 20.04 to %PRGF%, please wait..." "%PRGF%\LxRunOffline.exe" "i" "-n" "Pi-hole" "-f" "%TEMP%\install.tar.gz" "-d" "%PRGF%" 
ECHO. 
...
ECHO @SCHTASKS /RUN /TN "Pi-hole for WSL"                   >> "%PRGF%\Pi-hole_Reconfigure.cmd"
